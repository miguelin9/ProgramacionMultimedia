...
public class Material10 extends AppCompatActivity {
    ...
    private StaggeredGridLayoutManager gestor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestor = new StaggeredGridLayoutManager(2, 1);
        //gestor = new StaggeredGridLayoutManager(this,2, GridLayoutManager.VERTICAL,false);
        //gestor.setGapStrategy(StaggeredGridLayoutManager.GAP_HANDLING_MOVE_ITEMS_BETWEEN_SPANS);
        //gestor.setSpanSizeLookup()
